...
void AGGJ26_ProjectCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGGJ26_ProjectCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AGGJ26_ProjectCharacter::Look);
...
void AGGJ26_ProjectCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGGJ26_ProjectCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGGJ26_ProjectCharacter::DoMove(float Right, float Forward)
{
...
void AGGJ26_ProjectCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AGGJ26_ProjectCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AGGJ26_ProjectCharacter::DoJumpEnd()
{
